(() => {
  ...
  function setTheme(theme){const themes={default:['#434751','#dbdbdb'],light:['#ffffff','#252525'],sepia:['#eee5d3','#352f28'],night:['#24262b','#dedede'],black:['#111111','#e6e6e6']};const values=themes[theme]||themes.default;prefs.theme=theme;prefs.background=values[0];prefs.text=values[1];saveAndApply();}
