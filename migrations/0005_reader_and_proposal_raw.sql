...
CREATE INDEX IF NOT EXISTS idx_proposal_raw_user_created
  ON proposal_raw_uploads(user_telegram_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_proposal_raw_status_created
  ON proposal_raw_uploads(status, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_title_proposal_raw
  ON title_proposal_details(raw_upload_id);
